...
contract PrepareUpgradeScript is Script {
    ...
    function run() public {
        ...
        address newBridgeImpl = Upgrades.prepareUpgrade("BridgeV7Proxiable.sol", opts);
        ...
        bytes memory reinitializeCallData = abi.encodeCall(BridgeV7Proxiable.reinitialize, memo);
